...
public class QuestionDatabase {
    ...
    //Database
    public static final Map<String, String> DATABASE = new HashMap<String, String>();
    ...
    static {
        ...
        DATABASE.put("Facts and Statistics",
        ...
        {
            addQuestion(createQuestionItem(counter, entry.getKey(), entry.getValue()));
            counter += 1;
        }
